...
mysql_select_db($database_conn, $conn);
$query_Recordset1 = sprintf("SELECT * FROM lr_users WHERE user_id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<!-- InstanceBeginEditable name="EditRegion3" -->
  ...
  <div><form method="post" name="form1" action="<?php echo $editFormAction; ?>" onSubmit="return validateForm();">
  <table>
    <tr valign="baseline">
      <td nowrap align="right">Password:</td>
      <td><input type="text" name="password" id="password" value="<?php echo htmlentities($row_Recordset1['password'], ENT_COMPAT, ''); ?>" size="32"></td>
    </tr>
      <tr valign="baseline">
      <td nowrap align="right">Confirm Password:</td>
      <td><input type="text" name="confirm_password" id="confirm_password" size="32"></td>
    </tr>
